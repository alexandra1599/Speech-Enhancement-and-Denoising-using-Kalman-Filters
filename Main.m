tuned_kalman_speech_noizeus('sp01', 'train_noise', 50);
...
spath = strcat(ppath,'/Users/alexandramikhael/Downloads/');
   

for snri = 1:length(SNR)
    
    %read a clean audio signal
   [z,fs] = audioread('/Users/alexandramikhael/Downloads/clean/sp01.wav');
    ...
    if(strcmp(noiseType, 'white') == 1)
        ...
        fs = 48000;
        [y,fs] = audioread('/Users/alexandramikhael/Downloads/train_noise/0dB/sp01_train_sn0.wav');
    end
    y=y';
    z=z';
